...
from worker.transformer.decoder import get_decoder
from worker.transformer.encoder import get_encoder
...
class TrOMR(nn.Module):
    ...
    @torch.no_grad()
    def generate(self, x: torch.Tensor, keep_all_symbols_in_chord: bool) -> list[str]:
